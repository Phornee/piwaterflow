...
class Testing(unittest.TestCase):
    ...
    def test_0001_recalc_next_program(self):
        ...
        self.assertTrue(time_utc == datetime(2023, 4, 27, 9, 51, tzinfo=timezone.utc))
        ...
        time_utc, program_name = self.waterflow._recalc_next_program(last_program_time_utc, today) # pylint: disable=protected-access
        self.assertTrue(time_utc == datetime(2023, 4, 27, 19, 4, tzinfo=timezone.utc))
        ...
        time_utc, program_name = self.waterflow._recalc_next_program(last_program_time_utc, today) # pylint: disable=protected-access
        self.assertTrue(time_utc == datetime(2023, 4, 28, 9, 51, tzinfo=timezone.utc))
        self.assertTrue(program_name == 'first')
